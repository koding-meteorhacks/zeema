...
Zeema.check = function(appId,email,url){
	url = typeof url !== 'undefined' ? url : "https://zeema.ngrok.com";
...
window._zeema_check = function(payload){
	...
	if (payload && payload.status=='OK') {
		...
		zeema_text.innerHTML += "You <b>agree</b> with <b> All</b> terms of kadira.io";
		zeema_div.style.display='none';
		...
		zeema_btn.innerHTML += "Revice Now";
		...
		var zeema_text = document.createElement('span');
		zeema_text.id = 'zeema-no-agree-text';
		zeema_text.innerHTML += "You <b>don’t</b> agree with <b>"+payload.countNotAgreedTerms.length+"</b> terms of kadira.io";
		zeema_div.appendChild(zeema_text);
